      ...
      <div className="container py-4">
        ...
        <div className="row">
          <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
            ...
            >
              This Privacy Policy describes how maneology collects, uses, and
            ...
            <p className="py-2">
              ...
              customersupport@maneology.com or by mail using the details
              provided below:
            </p>
            <p>
              Corporate Address: Maneology- 101 Sai Iconic, Four Bunglows, Opp
              Kokilaben Hospital.
            </p>
            <h4
              style={{ fontSize: "28px", fontWeight: "600" }}
            ...
            <p className="py-2">
              ...
              Privacy Policy, we refer to any information about an identifiable
              individual (including the information below) as “Personal
            ...
            <ul>
              <li>
                ...
                fulfil our contract, to process your payment information,
            ...
            <p className="py-2">
              ...
              years. We do not intentionally collect Personal Information from
              children. If you are the parent or guardian and believe your child
              has provided us with Personal Information, please contact us at
              the address above to request deletion.
            </p>
            <h4
              style={{ fontSize: "28px", fontWeight: "600" }}
              className="py-2"
            ...
            <ul>
              ...
              <li>
                We use Meta Business to advertise our products and services on
                platforms like Facebook, Instagram & Whatsapp that use your
                personal information and your behavioural preferences on the
                social media platforms to showcase only the right products and
                services for you in a personalised manner.
              </li>
            </ul>
            ...
            <p>
              ...
              further processing, including to Canada and the United States.
            </p>
            <p>Cookies</p>
            <p>
            ...
            <p>
              We use the following cookies to optimise your experience on our
            ...
            <p>
              ...
              protection authority. The jurisdiction for all legal complaints
              and appeals will be at Chandigarh High Court and District
